 ...
 * <ul>
 *   <li>{@link it.univaq.flyaq.behaviour.impl.TakeOffImpl#getAltitude <em>Altitude</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TakeOffImpl extends MoveImpl implements TakeOff {
	/**
	...
	protected EClass eStaticClass() {
		return BehaviourPackage.Literals.TAKE_OFF;
	}
	...
	public void setAltitude(float newAltitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviourPackage.TAKE_OFF__ALTITUDE, oldAltitude, altitude));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviourPackage.TAKE_OFF__ALTITUDE:
				return getAltitude();
		}
