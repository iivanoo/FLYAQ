 ...
 * <ul>
 *   <li>{@link it.univaq.flyaq.behaviour.impl.HoverImpl#getDuration <em>Duration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HoverImpl extends MoveImpl implements Hover {
	/**
	...
	protected EClass eStaticClass() {
		return BehaviourPackage.Literals.HOVER;
	}
	...
	public void setDuration(float newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviourPackage.HOVER__DURATION, oldDuration, duration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviourPackage.HOVER__DURATION:
				return getDuration();
		}
