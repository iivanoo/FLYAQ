 ...
 * <ul>
 *   <li>{@link it.univaq.flyaq.behaviour.impl.FeedbackImpl#getActionName <em>Action Name</em>}</li>
 *   <li>{@link it.univaq.flyaq.behaviour.impl.FeedbackImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FeedbackImpl extends CommunicationActionImpl implements Feedback {
	/**
	...
	protected EClass eStaticClass() {
		return BehaviourPackage.Literals.FEEDBACK;
	}
	...
	public void setActionName(String newActionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviourPackage.FEEDBACK__ACTION_NAME, oldActionName, actionName));
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, BehaviourPackage.FEEDBACK__PARAMETERS);
		}
		return parameters;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviourPackage.FEEDBACK__PARAMETERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviourPackage.FEEDBACK__ACTION_NAME:
