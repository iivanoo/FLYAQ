 ...
 * <ul>
 *   <li>{@link it.univaq.flyaq.mission.impl.CoordinateImpl#getLatitude <em>Latitude</em>}</li>
 *   <li>{@link it.univaq.flyaq.mission.impl.CoordinateImpl#getLongitude <em>Longitude</em>}</li>
 *   <li>{@link it.univaq.flyaq.mission.impl.CoordinateImpl#getAltitude <em>Altitude</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CoordinateImpl extends MinimalEObjectImpl.Container implements Coordinate {
	...
	protected EClass eStaticClass() {
		return MissionPackage.Literals.COORDINATE;
	}
	...
	public void setLatitude(float newLatitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MissionPackage.COORDINATE__LATITUDE, oldLatitude, latitude));
	}
	...
	public void setLongitude(float newLongitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MissionPackage.COORDINATE__LONGITUDE, oldLongitude, longitude));
	}
	...
	public void setAltitude(float newAltitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MissionPackage.COORDINATE__ALTITUDE, oldAltitude, altitude));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MissionPackage.COORDINATE__LATITUDE:
				return getLatitude();
			case MissionPackage.COORDINATE__LONGITUDE:
				return getLongitude();
			case MissionPackage.COORDINATE__ALTITUDE:
				return getAltitude();
		}
