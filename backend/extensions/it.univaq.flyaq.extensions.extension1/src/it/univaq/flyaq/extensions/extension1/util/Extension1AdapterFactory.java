 ...
 * @generated
 */
public class Extension1AdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public Extension1AdapterFactory() {
	 ...
	 * @generated
	 */
	protected Extension1Switch<Adapter> modelSwitch =
		new Extension1Switch<Adapter>() {
			@Override
			public Adapter casePhotoGridTask(PhotoGridTask object) {
				return createPhotoGridTaskAdapter();
			}
			@Override
			public Adapter caseGoToTask(GoToTask object) {
				return createGoToTaskAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.univaq.flyaq.extensions.extension1.PhotoGridTask <em>Photo Grid Task</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPhotoGridTaskAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link it.univaq.flyaq.extensions.extension1.GoToTask <em>Go To Task</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGoToTaskAdapter() {
		return null;
	}
