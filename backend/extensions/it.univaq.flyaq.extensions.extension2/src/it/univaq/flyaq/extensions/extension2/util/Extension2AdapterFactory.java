 ...
 * @generated
 */
public class Extension2AdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public Extension2AdapterFactory() {
	 ...
	 * @generated
	 */
	protected Extension2Switch<Adapter> modelSwitch =
		new Extension2Switch<Adapter>() {
			@Override
			public Adapter caseRoadTask(RoadTask object) {
				return createRoadTaskAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.univaq.flyaq.extensions.extension2.RoadTask <em>Road Task</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRoadTaskAdapter() {
		return null;
	}
